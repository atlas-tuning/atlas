package com.github.manevolent.atlas.model.builtin;
...
import static com.github.manevolent.atlas.model.Unit.PSI;
...
public class SubaruWRX2022MT {
    ...
    public static Rom newRom() throws IOException {
        ...
        return Rom.builder()
                ...
                .withParameter(MemoryParameter.builder()
                        .withName("Req. Torque")
                        .withAddress(ram4, 0xfef03f0a)
                        .withScale(req_torque_16bit))
                .withParameter(MemoryParameter.builder()
                        .withName("RPM")
                        .withAddress(ram4, 0xfef03b19)
                        .withScale(rpm_8bit))
                .withParameter(MemoryParameter.builder()
                        .withName("RPM")
                        .withAddress(ram4, 0xfef03a1a)
                        .withScale(rpm_16bit))
                .withParameter(MemoryParameter.builder()
                        .withName("Wastegate Position")
                        .withAddress(ram4, 0xfef099a8)
                        .withScale(wastegatePosition16bitScale))
                .withParameter(MemoryParameter.builder()
                        .withName("Wastegate Position Base Table")
                        .withAddress(ram4, 0xfef09ae2)
                        .withScale(wastegatePosition16bitScale))
                .withParameter(MemoryParameter.builder()
                        .withName("Wastegate Position Final")
                        .withAddress(ram4, 0xfef09ada)
                        .withScale(wastegatePosition16bitScale))
                .withParameter(MemoryParameter.builder()
                        .withName("Wastegate Position Commanded")
                        .withAddress(ram4, 0xfef09adc)
                        .withScale(wastegatePosition16bitScale))
                .withParameter(MemoryParameter.builder()
                        .withName("Wastegate Position Commanded")
                        .withAddress(ram4, 0xfef09adc)
                        .withScale(wastegatePosition16bitScale))
                .withParameter(MemoryParameter.builder()
                        .withName("Req. Torque Mode 1 (Turbo)")
                        .withAddress(ram4, 0xfef0a40c)
                        .withScale(Scale.NONE))
                .withParameter(MemoryParameter.builder()
                        .withName("Req. Torque Mode 2 (Turbo)")
                        .withAddress(ram4, 0xfef0a40d)
                        .withScale(Scale.NONE))
                .withParameter(MemoryParameter.builder()
                        .withName("Wastegate Position Flags")
                        .withAddress(ram4, 0xfef0a40e)
                        .withScale(Scale.NONE))
                .withParameter(MemoryParameter.builder()
                        .withName("Wastegate Position Minimum")
                        .withAddress(ram4, 0xfef09ade)
                        .withScale(wastegatePosition16bitScale))
                .withTable(
                        Table.builder()
